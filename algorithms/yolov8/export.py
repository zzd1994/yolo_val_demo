...
from models.utils.dataloaders import LoadImages
from models.utils.general import (LOGGER, check_dataset, check_img_size, check_requirements, check_version, check_yaml,
                           colorstr, file_size, print_args, url2file)
from models.utils.torch_utils import select_device, smart_inference_mode
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='../../weights/gbs5960_v6s_20220524.pt', help='model.pt path(s)')
    ...
    # parser.add_argument('--half', default=True, help='FP16 half-precision export')
